...
{
	public class RGNukeBeaconTargetInfo : ITraitInfo
	{
	...
	public class RGNukeBeaconTarget : ITick, IRGPostRender, IRGBeaconTarget
	{
		...
		public void Tick(Actor self)
		{
			...
			{
				RGGame.EVA("Nuclear strike approaching!");
		...
		public void DoDisarm(Player disarmer, float amount)
		{
			if (DisarmProgress < 1f)
			{
				...
				if (DisarmProgress >= 1f)
				{
					...
					RGGame.EVA("Nuke Beacon disarmed!");
				}
			}
		}
