...
{
	public class RGBeaconTargetInfo : ITraitInfo
	{
	...
	public class RGBeaconTarget : ITick, IRGPostRender
	{
		...
		public void TriggerLaunch(Player launcher, Actor launchSite, int ticks)
		{
			...
			RGGame.EVA("{0} has placed {1} beacon on the {2}.".F(launcher.PlayerName, beaconType,
