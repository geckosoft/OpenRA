...
{
	public class RgServerBrowserDelegate : IWidgetDelegate
	{
		...
		public RgServerBrowserDelegate( [ObjectCreator.Param] Widget widget )
		{
			...
			{
				bg.GetWidget("JOINSERVER_PROGRESS_TITLE").Visible = true;
				bg.GetWidget<LabelWidget>("JOINSERVER_PROGRESS_TITLE").Text = "Consulting EVA ...";
		...
		{
			return string.Join("\n", currentServer.Mods.Where(m => m != "rg").Select(m =>  
