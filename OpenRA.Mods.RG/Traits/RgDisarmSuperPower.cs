...
namespace OpenRA.Mods.Rg.Traits
{
    ...
    public class RgDisarmSuperPower : IIssueOrder, IResolveOrder, IOrderVoice
    {
        ...
        {
            if (order.OrderString == "DisarmBeacon" && order.TargetActor.Owner.Stances[order.Subject.Owner] == Stance.Ally) /* only target allied buildings */
            {
        ...
        class DisarmSuperPowerOrderTargeter : UnitTraitOrderTargeter<Building>
        {
